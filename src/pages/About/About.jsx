    ...
    <div>
      <div className="flex items-center gap-3 justify-center mt-10">
        <p className="text-2xl tracking-wide text-secondary dark:text-primary   ">
          <span className="text-gray-500 dark:text-primary-100">ABOUT</span> US
        </p>
      ...
      <div className="grid grid-cols-12">
        ...
        <div className="col-span-8 flex">
          <div className="flex flex-col justify-center gap-6  text-secondary dark:text-primary">
            <p>
      ...
      <div className="inline-flex gap-2 items-center mb-3 mt-16">
        ...
        <p className="w-8 sm:w-12 h-[1px] sm:h-[2px] bg-secondary dark:bg-primary"></p>
      </div>
      <div className="flex flex-col md:flex-row text-sm mb-20">
        <div className="border border-primary px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
